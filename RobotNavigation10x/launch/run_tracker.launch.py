"""
Pure Pursuit Controller Launch File
Launches TurtleBot3 in clean environment with Pure Pursuit trajectory tracking.
Demonstrates basic geometric path following without obstacle avoidance.
"""
...
def generate_launch_description():
    ...
    # Environment setup: clean world without obstacles
    world = os.path.join(
    ...
    # Start Pure Pursuit trajectory tracker
    start_tracker_node = Node(
    ...
    ld.add_action(start_tracker_node)
